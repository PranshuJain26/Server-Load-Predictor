...
print("--- Starting M66 (XGBoost, Hourly) Training ---")

MODEL_NAME = "A66\\M66_hourly.joblib"
DATA_SOURCE_RAW = "A66\\A66.csv"
DATA_SOURCE_PROCESSED = "A66\\A66_hourly_calls.csv"
...
print("--- M66 Hourly XGBoost Training Finished ---")
