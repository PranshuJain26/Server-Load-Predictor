...
print("--- Starting M7 (RandomForest, Daily) Training ---")

MODEL_NAME = "A7\\M7_daily.joblib"
DATA_SOURCE_RAW = "A7\\A7.csv"
DATA_SOURCE_PROCESSED = "A7\\A7_daily_calls.csv"
...
print(f"Saved daily data → {DATA_SOURCE_PROCESSED} ({len(df_daily)} days)")
...
print("--- M7 Daily RandomForest Training Finished ---")
