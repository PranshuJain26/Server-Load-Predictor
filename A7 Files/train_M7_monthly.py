...
print("--- Starting M7 (Monthly Moving Average) Training ---")

MODEL_NAME = "A7\\M7_monthly.joblib"
DATA_SOURCE_RAW = "A7\\A7.csv"
DATA_SOURCE_PROCESSED = "A7\\A7_monthly_calls.csv"
WINDOW = 3  # same default as your function
...
# --------------------------------------------------
# 3. Moving Average Forecast (MONTHLY)
# --------------------------------------------------
preds = []
...
print(f"Validation RMSE (Monthly Moving Average): {rmse:.2f}")
...
artifact = {
    "window": WINDOW,
    "history": list(y)  # full history for future rolling prediction
}

joblib.dump(artifact, MODEL_NAME)
print(f"Saved moving average artifact → {MODEL_NAME}")

print("--- M7 Monthly Moving Average Training Finished ---")
