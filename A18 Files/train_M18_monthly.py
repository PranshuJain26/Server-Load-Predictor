...
print("--- Starting M18 (Naive, Monthly) Training ---")

MODEL_NAME = "A18\\M18_monthly.joblib"
DATA_SOURCE_RAW = "A18\\A18.csv"
DATA_SOURCE_PROCESSED = "A18\\A18_monthly_calls.csv"
...
print(f"Validation RMSE (Monthly Naive): {rmse:.3f}")
...
print("--- M18 Monthly Naive Training Finished ---")
