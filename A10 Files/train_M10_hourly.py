...
print("--- Starting M10 (XGBoost, Hourly) Training ---")

MODEL_NAME = "A10\\M10_hourly.joblib"
DATA_SOURCE_RAW = "A10\\A10.csv"
DATA_SOURCE_PROCESSED = "A10\\A10_hourly_calls.csv"
...
# --------------------------------------------------
# 4. Train XGBoost Model (CHANGED)
# --------------------------------------------------
print("Training XGBoost model...")

model = XGBRegressor(
    n_estimators=400,        # changed
    learning_rate=0.03,      # changed
    max_depth=4,             # changed
    subsample=0.8,
...
print("--- M10 Hourly XGBoost Training Finished ---")
