...
print("--- Starting M10 (Monthly Moving Average) Training ---")

MODEL_NAME = "A10\\M10_monthly.joblib"
DATA_SOURCE_RAW = "A10\\A10.csv"
DATA_SOURCE_PROCESSED = "A10\\A10_monthly_calls.csv"
...
print("--- M10 Monthly Moving Average Training Finished")
