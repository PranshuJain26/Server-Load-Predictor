...
print("--- Starting M45 (MovingAverage, Monthly) Training ---")

MODEL_NAME = "A45\\M45_monthly.joblib"
DATA_SOURCE_RAW = "A45\\A45.csv"
DATA_SOURCE_PROCESSED = "A45\\A45_monthly_calls.csv"
WINDOW = 3
...
print("--- M45 Monthly MovingAverage Training Finished ---")
