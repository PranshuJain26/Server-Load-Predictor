...
print("--- Loading M45 (Daily) XGBoost Model ---")

MODEL_NAME = "A45\\M45_daily.joblib"
DATA_NAME = "A45\\A45_daily_calls.csv"
...
# --------------------------------------------------
def predict():
    """Predict NEXT DAY call count for API A45 using XGBoost."""
    ...
    try:
        ...
        target_date = last_known + pd.Timedelta(days=1)
