...
print("--- Starting M31 (Naive, Weekly) Training ---")

MODEL_NAME = "A31\\M31_weekly.joblib"
DATA_SOURCE_RAW = "A31\\A31.csv"
DATA_SOURCE_PROCESSED = "A31\\A31_weekly_calls.csv"
...
print("--- M31 Weekly Naive Training Finished ---")
