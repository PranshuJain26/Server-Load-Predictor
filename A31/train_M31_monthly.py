...
print("--- Starting M31 (MovingAverage, Monthly) Training ---")

MODEL_NAME = "A31\\M31_monthly.joblib"
DATA_SOURCE_RAW = "A31\\A31.csv"
DATA_SOURCE_PROCESSED = "A31\\A31_monthly_calls.csv"
WINDOW = 3
...
print("--- M31 Monthly MovingAverage Training Finished ---")
