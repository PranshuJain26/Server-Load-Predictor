...
print("--- Starting M21 (MovingAverage, Monthly) Training ---")

MODEL_NAME = "A21\\M21_monthly.joblib"
DATA_SOURCE_RAW = "A21\\A21.csv"
DATA_SOURCE_PROCESSED = "A21\\A21_monthly_calls.csv"
WINDOW = 3
...
print(f"Validation RMSE (Monthly MovingAverage): {rmse:.3f}")
...
print("--- M21 Monthly MovingAverage Training Finished ---")
