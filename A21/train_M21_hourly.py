...
print("--- Starting M21 (SARIMA, Hourly) Training ---")

MODEL_NAME = "A21\\M21_hourly.joblib"
DATA_SOURCE_RAW = "A21\\A21.csv"
DATA_SOURCE_PROCESSED = "A21\\A21_hourly_calls.csv"
...
print("--- M21 Hourly SARIMA Training Finished ---")
