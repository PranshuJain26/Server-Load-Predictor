...
print("--- Starting M21 (SARIMA, Daily) Training ---")

MODEL_NAME = "A21\\M21_daily.joblib"
DATA_SOURCE_RAW = "A21\\A21.csv"
DATA_SOURCE_PROCESSED = "A21\\A21_daily_calls.csv"
...
print("--- M21 Daily SARIMA Training Finished ---")
