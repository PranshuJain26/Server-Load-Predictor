...
print("--- Starting M40 (MovingAverage, Monthly) Training ---")

MODEL_NAME = "A40\\M40_monthly.joblib"
DATA_SOURCE_RAW = "A40\\A40.csv"
DATA_SOURCE_PROCESSED = "A40\\A40_monthly_calls.csv"
WINDOW = 3
...
print("--- M40 Monthly MovingAverage Training Finished ---")
